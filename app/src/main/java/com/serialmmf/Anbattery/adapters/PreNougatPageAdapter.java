...
import com.serialmmf.Anbattery.memory.MemoryFragment;
...
public class PreNougatPageAdapter extends FragmentPagerAdapter
{

    public PreNougatPageAdapter(FragmentManager fm) {
        super(fm);
    }
